...
# Automatic, low-rate diagnostic recording for each personal driving run.
# At DRIVE_LOOP_HZ=20, every 10 frames is about 2 captures per second.
...
CV_DEBUG_CAPTURE_QUEUE_SIZE = 32
