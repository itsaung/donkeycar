...
DATA_PATH = "/home/sungsan/mycar/data"
...
# controller scales it to the required 426x260 OAK-D runtime frame.
...
# Maintain enough torque to keep moving after the initial launch.
THROTTLE_MIN = 0.26
THROTTLE_INITIAL = THROTTLE_MIN
THROTTLE_MAX = 0.32
THROTTLE_STEP = 0.02
START_BOOST_THROTTLE = 0.30
START_BOOST_FRAMES = 6
RESTART_BOOST_AFTER_LOST_FRAMES = 2
